...
import { Person, TodoForm } from '../components';
    ...
    render(){
        ...
        return(
            <Fragment>
                ...
                <div className = "button_ment">
                    <button className = "add_button" id="add" onClick={this.handleCreate.bind(this)}><Icon name="add" /></button>&nbsp;&nbsp;&nbsp;<div className="add_task">Add task</div>
                </div>
                <div>
